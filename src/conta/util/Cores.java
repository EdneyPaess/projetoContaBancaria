...
public class Cores {
	...
	//Text color/8 cores básicas para serem aplicadas ao texto
	...
	//Text Color Bold/8 cores básicas com a propriedade negrito (bold)
	...
	//Reset Text Underline/8 cores básicas com a propriedade sublinhado
	...
	//Text Color High Intensity/efeito brilho (cor mais clara)
	...
	//Text Color Bold High Intensity/8 cores básicas com efeito brilho (cor mais clara) e a propriedade negrito (bold) habilitada
	...
	//Background Color/8 cores básicas para serem aplicadas ao fundo da tela (background)
	...
	//Background Color High Intensity/8 cores básicas com efeito brilho (cor mais clara) para serem aplicadas ao fundo da tela (background)

...
public class ContaController implements contaRepository {
	...
	public void atualizar(Conta conta) {
		...
		if (buscaConta != null) {
			...
			System.out.println("\nA Conta numero: " + conta.getNumero() + "não foi encontrads!");
		}
	...
	public void deletar(int numero) {
		...
		if (conta != null) {
			if (listaContas.remove(conta) == true) {
				System.out.println("\nConra numero: " + numero + " foi deletada com sucesso!");
			} else {
				System.out.println("znA conta numero: " + numero + " não foi encontrada!");
			}
		}
	...
	public void depositar(int numero, float valor) {
		...
		if(buscaConta != null) {
			...
			System.out.println("\nA Conta numero: "+numero+ " não foi encontrada ou a conta detino não é uma conta Corrente");
		}
